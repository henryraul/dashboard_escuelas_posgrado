...
st.set_page_config(
    ...
    page_icon='D:\\Projects\\Diplomado\\data\\favicon.png',
    layout='wide'
)
...
DATASETS = {
    'Escuela de Verano 2021': {
        'path': 'D:\\Projects\\Diplomado\\data\\EV2021.csv.zip',
        'column': 'Q05_pregunta',
        'url': '#',
        'description': (
    ...
    'Escuela de Invierno 2021': {
        'path': 'D:\\Projects\\Diplomado\\data\\EI2021.csv.zip',
        'column': 'Q05_pregunta',
        'url': '#',
        'description': (
...
WORDCLOUD_FONT_PATH = r'D:\\Projects\\Diplomado\\data\\Inkfree.ttf'
...
if __name__ == '__main__':
    ...
    with st.expander('Hero Image'):
        img = Image.open('D:\\Projects\\Diplomado\\data\\is-this-a-topic-modeling.jpg')
    ...
    with st.expander('Detalles adicionales'):
        ...
        img = Image.open('D:\\Projects\\Diplomado\\data\\mf.png')
